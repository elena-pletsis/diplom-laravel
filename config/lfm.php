...
return [
    ...
    */
    ...
    //If true у каждого пользователя будет своя папка и 1 админ не будет видет папку второго
    ...
    */
    ...
    //куда будут загружаться картинки
    ...
    */
    ...
    'rename_file' => true,
    //будем переименовывать картинки
 ...
 //будет создаваться превью - маленькая картинка - размеры можно указать свои
    /*
    |--------------------------------------------------------------------------
